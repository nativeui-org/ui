...
export { Sheet };
`}
      previewCode={`import { Sheet } from "@nativeui/ui";

export default function SheetDemo() {
  return (
    <div className="flex flex-col gap-4">
      <Sheet>Default Sheet</Sheet>
      <Sheet variant="destructive">Delete</Sheet>
      <Sheet variant="outline">Outline</Sheet>
      <Sheet variant="secondary">Secondary</Sheet>
      <Sheet variant="ghost">Ghost</Sheet>
      <Sheet variant="link">Link</Sheet>
    </div>
  );
}`}
      registryName="sheet"
