...
`}
      previewCode={`import { Dropdown } from "@nativeui/ui";

export default function DropdownDemo() {
  return (
    <div className="flex flex-col gap-4">
      <Dropdown>Default Dropdown</Dropdown>
      <Dropdown variant="destructive">Delete</Dropdown>
      <Dropdown variant="outline">Outline</Dropdown>
      <Dropdown variant="secondary">Secondary</Dropdown>
      <Dropdown variant="ghost">Ghost</Dropdown>
      <Dropdown variant="link">Link</Dropdown>
    </div>
  );
}`}
