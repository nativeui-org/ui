...
`}
      previewCode={`import { Calendar } from "@nativeui/ui";

export default function CalendarDemo() {
  return (
    <div className="flex flex-col gap-4">
      <Calendar>Default Calendar</Calendar>
      <Calendar variant="destructive">Delete</Calendar>
      <Calendar variant="outline">Outline</Calendar>
      <Calendar variant="secondary">Secondary</Calendar>
      <Calendar variant="ghost">Ghost</Calendar>
      <Calendar variant="link">Link</Calendar>
    </div>
  );
}`}
