...
`}
      previewCode={`import { Tooltip } from "@nativeui/ui";

export default function TooltipDemo() {
  return (
    <div className="flex flex-col gap-4">
      <Tooltip>Default Tooltip</Tooltip>
      <Tooltip variant="destructive">Delete</Tooltip>
      <Tooltip variant="outline">Outline</Tooltip>
      <Tooltip variant="secondary">Secondary</Tooltip>
      <Tooltip variant="ghost">Ghost</Tooltip>
      <Tooltip variant="link">Link</Tooltip>
    </div>
  );
}`}
