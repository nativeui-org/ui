...
`}
      previewCode={`import { Carousel } from "@nativeui/ui";

export default function CarouselDemo() {
  return (
    <div className="flex flex-col gap-4">
      <Carousel>Default Carousel</Carousel>
      <Carousel variant="destructive">Delete</Carousel>
      <Carousel variant="outline">Outline</Carousel>
      <Carousel variant="secondary">Secondary</Carousel>
      <Carousel variant="ghost">Ghost</Carousel>
      <Carousel variant="link">Link</Carousel>
    </div>
  );
}`}
