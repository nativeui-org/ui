...
`}
      previewCode={`import { Breadcrumb } from "@nativeui/ui";

export default function BreadcrumbDemo() {
  return (
    <div className="flex flex-col gap-4">
      <Breadcrumb>Default Breadcrumb</Breadcrumb>
      <Breadcrumb variant="destructive">Delete</Breadcrumb>
      <Breadcrumb variant="outline">Outline</Breadcrumb>
      <Breadcrumb variant="secondary">Secondary</Breadcrumb>
      <Breadcrumb variant="ghost">Ghost</Breadcrumb>
      <Breadcrumb variant="link">Link</Breadcrumb>
    </div>
  );
}`}
