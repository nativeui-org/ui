...
```bash
npx @nativeui/cli add date-time-picker
```
...
```bash
npm install react-native date-fns @expo/vector-icons
```
...
The DateTimePicker component accepts all standard HTML attributes plus:
