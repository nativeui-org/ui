...
```bash
npm install react-native date-fns @expo/vector-icons @react-native-community/datetimepicker
```
...
The Calendar component accepts all standard HTML attributes plus:
