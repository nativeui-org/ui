...
A alert-dialog component for React Native applications.

## Installation

```bash
npx @nativeui/cli add alert-dialog
```
...
The AlertDialog component accepts all standard HTML attributes plus:
