...
```bash
npm install react-native react-native-safe-area-context @expo/vector-icons
```
...
The Sheet component accepts all standard HTML attributes plus:
